...
var adapters_server_grpc_protobuf_service_pb = require('./service_pb.js');

function serialize_AppendEntriesRequest(arg) {
  if (!(arg instanceof adapters_server_grpc_protobuf_service_pb.AppendEntriesRequest)) {
...
function deserialize_AppendEntriesRequest(buffer_arg) {
  return adapters_server_grpc_protobuf_service_pb.AppendEntriesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_AppendEntriesResponse(arg) {
  if (!(arg instanceof adapters_server_grpc_protobuf_service_pb.AppendEntriesResponse)) {
...
function deserialize_AppendEntriesResponse(buffer_arg) {
  return adapters_server_grpc_protobuf_service_pb.AppendEntriesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var RaftNodeService = exports.RaftNodeService = {
  ...
  appendEntries: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: adapters_server_grpc_protobuf_service_pb.AppendEntriesRequest,
    responseType: adapters_server_grpc_protobuf_service_pb.AppendEntriesResponse,

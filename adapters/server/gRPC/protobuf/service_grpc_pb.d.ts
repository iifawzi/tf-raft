...
interface IRaftNodeService_IAppendEntries extends grpc.MethodDefinition<adapters_server_grpc_protobuf_service_pb.AppendEntriesRequest, adapters_server_grpc_protobuf_service_pb.AppendEntriesResponse> {
    path: "/RaftNode/AppendEntries";
    requestStream: false;
    responseStream: false;
    requestSerialize: grpc.serialize<adapters_server_grpc_protobuf_service_pb.AppendEntriesRequest>;
    requestDeserialize: grpc.deserialize<adapters_server_grpc_protobuf_service_pb.AppendEntriesRequest>;
    responseSerialize: grpc.serialize<adapters_server_grpc_protobuf_service_pb.AppendEntriesResponse>;
    responseDeserialize: grpc.deserialize<adapters_server_grpc_protobuf_service_pb.AppendEntriesResponse>;
}
...
export interface IRaftNodeServer extends grpc.UntypedServiceImplementation {
    ...
    appendEntries: grpc.handleUnaryCall<adapters_server_grpc_protobuf_service_pb.AppendEntriesRequest, adapters_server_grpc_protobuf_service_pb.AppendEntriesResponse>;
}
...
export interface IRaftNodeClient {
    ...
    appendEntries(request: adapters_server_grpc_protobuf_service_pb.AppendEntriesRequest, callback: (error: grpc.ServiceError | null, response: adapters_server_grpc_protobuf_service_pb.AppendEntriesResponse) => void): grpc.ClientUnaryCall;
    appendEntries(request: adapters_server_grpc_protobuf_service_pb.AppendEntriesRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: adapters_server_grpc_protobuf_service_pb.AppendEntriesResponse) => void): grpc.ClientUnaryCall;
    appendEntries(request: adapters_server_grpc_protobuf_service_pb.AppendEntriesRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: adapters_server_grpc_protobuf_service_pb.AppendEntriesResponse) => void): grpc.ClientUnaryCall;
}
...
export class RaftNodeClient extends grpc.Client implements IRaftNodeClient {
    ...
    public appendEntries(request: adapters_server_grpc_protobuf_service_pb.AppendEntriesRequest, callback: (error: grpc.ServiceError | null, response: adapters_server_grpc_protobuf_service_pb.AppendEntriesResponse) => void): grpc.ClientUnaryCall;
    public appendEntries(request: adapters_server_grpc_protobuf_service_pb.AppendEntriesRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: adapters_server_grpc_protobuf_service_pb.AppendEntriesResponse) => void): grpc.ClientUnaryCall;
    public appendEntries(request: adapters_server_grpc_protobuf_service_pb.AppendEntriesRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: adapters_server_grpc_protobuf_service_pb.AppendEntriesResponse) => void): grpc.ClientUnaryCall;
}
